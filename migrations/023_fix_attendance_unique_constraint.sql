-- =============================================
-- Migration 023: attendance 테이블 UNIQUE 제약조건 수정
-- =============================================
...
DROP CONSTRAINT IF EXISTS attendance_employee_id_date_key CASCADE;
...
CREATE OR REPLACE FUNCTION update_attendance_check_in_date()
RETURNS TRIGGER AS $$
BEGIN
...
-- TRIGGER 생성
DROP TRIGGER IF EXISTS trigger_update_attendance_check_in_date ON attendance;
...
DO $$
BEGIN
  RAISE NOTICE '✅ attendance UNIQUE 제약조건 수정 완료!';
