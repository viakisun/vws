...
import { Users as UsersIcon, Key as KeyIcon, ShieldCheck as ShieldCheckIcon, AlertCircle as AlertCircleIcon, Shield as ShieldIcon } from 'lucide-svelte';
...
class PermissionManagementStore {
  ...
  stats = $derived([
    ...
    },
    {
      ...
      color: this.users.filter(u => u.roles.length === 0).length > 0 ? 'red' as const : 'green' as const
    }
  ]);
