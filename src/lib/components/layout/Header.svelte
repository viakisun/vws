...
<header class="h-16 flex items-center justify-between px-6 border-b" style="background: var(--color-surface); border-color: var(--color-border);">
	...
	<div class="flex-1 max-w-md mx-8">
		<div class="relative">
			<SearchIcon size={16} class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
			<input
				type="search"
				placeholder="검색..."
	...
	<div class="flex items-center space-x-3">
		...
		>
			<div class="relative">
				{#if $isDark}
					<SunIcon size={22} class="transition-transform duration-200 group-hover:scale-110 group-hover:rotate-12" />
				{:else}
					<MoonIcon size={22} class="transition-transform duration-200 group-hover:scale-110 group-hover:-rotate-12" />
				{/if}
			</div>
		</ThemeButton>
		...
		<div class="relative" bind:this={notificationsContainer}>
			<ThemeButton 
				...
				class="relative p-3 rounded-xl hover:shadow-lg transition-all duration-300 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100 hover:scale-105 group {showNotifications ? 'bg-blue-50 dark:bg-blue-900/20' : ''}"
			>
				<div class="relative">
					<BellIcon size={22} class="transition-transform duration-200 {showNotifications ? 'animate-pulse' : 'group-hover:scale-110'}" />
					{#if unreadCount > 0}
			...
			{#if showNotifications}
				...
				>
						...
						<div class="px-6 py-4 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-gray-800 dark:hover:to-gray-700 border-b border-gray-100 transition-all duration-200 cursor-pointer group">
							<div class="flex items-start space-x-3">
								...
								<div class="flex-1 min-w-0">
									...
									<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">PSR팀에서 새로운 연구 프로젝트 승인을 요청했습니다.</p>
						...
						<div class="px-6 py-4 hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50 dark:hover:from-gray-800 dark:hover:to-gray-700 border-b border-gray-100 transition-all duration-200 cursor-pointer group">
							<div class="flex items-start space-x-3">
								...
								<div class="flex-1 min-w-0">
									...
									<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">이번 달 연구 보고서 제출 마감이 3일 남았습니다.</p>
						...
						<div class="px-6 py-4 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200 cursor-pointer group">
							<div class="flex items-start space-x-3">
								...
								<div class="flex-1 min-w-0">
									...
									<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">내일 오전 10시 팀 회의가 오후 2시로 변경되었습니다.</p>
					...
					<div class="px-6 py-3 border-t border-gray-100 bg-gray-50 dark:bg-gray-800">
						<button class="w-full text-center text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
							모든 알림 보기
						</button>
					</div>
				</ThemeDropdown>
		...
		<div class="relative" bind:this={userMenuContainer}>
			<ThemeButton 
				...
				class="flex items-center space-x-3 p-3 rounded-xl hover:shadow-lg transition-all duration-300 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100 hover:scale-105 group {showUserMenu ? 'bg-blue-50 dark:bg-blue-900/20' : ''}"
			>
				<div class="relative">
					<ThemeAvatar 
						size="md" 
			...
			{#if showUserMenu}
				...
				>
					<div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700">
						<div class="flex items-center space-x-4">
							<div class="relative">
								...
								/>
								<div class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 border-2 border-white dark:border-gray-700 rounded-full"></div>
							</div>
							<div class="flex-1 min-w-0">
					...
					<div class="py-2">
						<a href="/profile" class="flex items-center px-6 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200 group">
						...
						<a href="/settings" class="flex items-center px-6 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-slate-50 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200 group">
						...
						<a href="/logout" class="flex items-center px-6 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 dark:hover:from-red-900/20 dark:hover:to-pink-900/20 transition-all duration-200 group">
