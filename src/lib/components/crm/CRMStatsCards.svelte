...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
      <div>
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">총 고객 수</p>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
      <div>
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">활성 계약 총액</p>
      ...
      <div class="p-3 bg-green-100 dark:bg-green-900/50 rounded-lg">
        <FileTextIcon class="w-6 h-6 text-green-600 dark:text-green-400" />
      </div>
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
      <div>
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">순 계약 가치</p>
        <p
        ...
        <p class="text-sm text-gray-500 dark:text-gray-500 mt-1">수령 - 지급</p>
      </div>
      <div
      ...
      >
        <DollarSignIcon
          class="w-6 h-6 {stats.netContractValue >= 0
            ? 'text-orange-600 dark:text-orange-400'
            : 'text-red-600 dark:text-red-400'}"
        />
      </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="flex items-center justify-between">
      <div>
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">진행 중인 기회</p>
      ...
      <div class="p-3 bg-purple-100 dark:bg-purple-900/50 rounded-lg">
        <TargetIcon class="w-6 h-6 text-purple-600 dark:text-purple-400" />
      </div>
    </div>
  </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
    <div class="flex items-center justify-between">
      <div class="flex-1">
        <p class="text-xs font-medium text-gray-600 dark:text-gray-400">이번 달 신규 고객</p>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
    <div class="flex-1">
      <p class="text-xs font-medium text-gray-600 dark:text-gray-400">지급 예정 총액</p>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
    <div class="flex-1">
      <p class="text-xs font-medium text-gray-600 dark:text-gray-400">30일 내 갱신 예정</p>
