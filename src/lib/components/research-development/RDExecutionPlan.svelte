<script lang="ts">
    ...
    try {
      ...
      const response = await fetch(`/api/research-development/project-budgets/${budget.id}`, {
        ...
        body: JSON.stringify({
          ...
          researchMaterialCostInKind: parseFloat(String(budget.research_material_cost_in_kind)) || 0,
          researchActivityCostInKind: parseFloat(String(budget.research_activity_cost_in_kind)) || 0,
  ...
  async function addNewYear() {
    try {
      ...
      const nextPeriod = projectBudgets.length > 0 ? Math.max(...projectBudgets.map((b) => b.period_number)) + 1 : 1
        ...
        {#each projectBudgets as budget, i (budget.id || i)}
          ...
          >
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'personnel_cost_cash'}
                ...
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'personnel_cost_in_kind'}
              ...
              <div class="flex flex-col gap-2">
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_material_cost_cash'}
                    onStartEdit={() => startEditingCell(i, 'research_material_cost_cash')}
                    onStopEdit={stopEditingCell}
                    onChange={(value) => handleValueChange(i, 'research_material_cost_cash', value)}
                    textColor="text-blue-600"
                  />
                </div>
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_material_cost_in_kind'}
                    onStartEdit={() => startEditingCell(i, 'research_material_cost_in_kind')}
                    onStopEdit={stopEditingCell}
                    onChange={(value) => handleValueChange(i, 'research_material_cost_in_kind', value)}
                    textColor="text-gray-600"
                  />
                </div>
              </div>
              ...
              <div class="flex flex-col gap-2">
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_activity_cost_cash'}
                    onStartEdit={() => startEditingCell(i, 'research_activity_cost_cash')}
                    onStopEdit={stopEditingCell}
                    onChange={(value) => handleValueChange(i, 'research_activity_cost_cash', value)}
                    textColor="text-blue-600"
                  />
                </div>
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_activity_cost_in_kind'}
                    onStartEdit={() => startEditingCell(i, 'research_activity_cost_in_kind')}
                    onStopEdit={stopEditingCell}
                    onChange={(value) => handleValueChange(i, 'research_activity_cost_in_kind', value)}
                    textColor="text-gray-600"
                  />
                </div>
              </div>
              ...
              <div class="flex flex-col gap-2">
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_stipend_cash'}
                ...
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'research_stipend_in_kind'}
              ...
              <div class="flex flex-col gap-2">
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'indirect_cost_cash'}
                ...
                <div class="min-h-[2rem] flex items-center justify-end">
                  <RDEditableNumberCell
                    ...
                    isEditing={editingCell?.index === i && editingCell?.field === 'indirect_cost_in_kind'}
            ...
            <td class="px-4 py-4 text-sm font-medium text-gray-900 text-right">
              <div class="flex flex-col gap-2">
                <div class="min-h-[2rem] flex items-center justify-end text-blue-600 font-semibold">
                  {formatRDCurrency(cashTotal)}
                </div>
                <div class="min-h-[2rem] flex items-center justify-end text-gray-600 font-semibold">
