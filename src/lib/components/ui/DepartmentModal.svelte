...
<ThemeModal {open} onclose={handleClose} size="md">
	<div class="space-y-6">
		...
		<form onsubmit={(e) => { e.preventDefault(); handleSave(); }} class="space-y-4">
			<!-- 부서명 -->
			<div>
				<label for="dept-name" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					부서명 *
				</label>
				<input
					id="dept-name"
			...
			<!-- 부서 설명 -->
			<div>
				<label for="dept-description" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					부서 설명
				</label>
				<textarea
					id="dept-description"
			...
			<!-- 상태 -->
			<div>
				<label for="dept-status" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					상태
				</label>
				<select
					id="dept-status"
