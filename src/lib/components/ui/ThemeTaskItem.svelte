...
<div
  class="flex items-center justify-between p-4 rounded-xl transition-all duration-200 hover:scale-[1.02] {className}"
...
>
  <div class="flex items-center space-x-3 flex-1 min-w-0">
    {#if icon}
      ...
      >
        <icon class="h-4 w-4" style="color: var(--color-primary);"></icon>
      </div>
    {/if}
  ...
  <ThemeButton variant="primary" size="sm" onclick={handleAction}>처리</ThemeButton>
</div>
