<script lang="ts">
  ...
  function handleSave() {
    ...
    const dataToSave = {
      ...
      job_title_id:
        formData.job_title_id && formData.job_title_id.trim() !== '' ? formData.job_title_id : null,
    }
  ...
  <div class="p-6">
    ...
    <div class="flex gap-2 mb-6 border-b" style:border-color="var(--color-border)">
      ...
      <button
        ...
        style:color={activeTab === 'employment'
          ? 'var(--color-primary)'
      ...
      <button
        ...
        style:color={activeTab === 'additional'
          ? 'var(--color-primary)'
          : 'var(--color-text-secondary)'}
      >
        추가 정보
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="md:col-span-2">
            <label
              for="salary"
              class="block text-sm font-medium mb-2"
              style:color="var(--color-text)">급여 정보</label
            >
