...
<div class={getSliderClasses()} {...restProps}>
	...
	<div class="theme-slider-track" style="background: linear-gradient(to right, {getColor()} 0%, {getColor()} {getPercentage()}%, var(--color-border) {getPercentage()}%, var(--color-border) 100%);">
		<div class="theme-slider-thumb" style="left: {getPercentage()}%; background: {getColor()};"></div>
	</div>
