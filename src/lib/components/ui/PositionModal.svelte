...
<ThemeModal {open} onclose={handleClose} size="md">
	<div class="space-y-6">
		...
		<form onsubmit={(e) => { e.preventDefault(); handleSave(); }} class="space-y-4">
			<!-- 부서 선택 -->
			<div>
				<label for="pos-department" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					부서 *
				</label>
				<select
					id="pos-department"
			...
			<!-- 직급명 -->
			<div>
				<label for="pos-name" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					직급명 *
				</label>
				<input
					id="pos-name"
			...
			<!-- 직급 설명 -->
			<div>
				<label for="pos-description" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					직급 설명
				</label>
				<textarea
					id="pos-description"
			...
			<!-- 직급 레벨 -->
			<div>
				<label for="pos-level" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					직급 레벨
				</label>
				<input
					id="pos-level"
			...
			<!-- 상태 -->
			<div>
				<label for="pos-status" class="block text-sm font-medium mb-2" style="color: var(--color-text);">
					상태
				</label>
				<select
					id="pos-status"
