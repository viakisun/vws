...
<div class="notification-bell-container relative">
  ...
  {#if showDropdown}
    ...
    >
        ...
        {:else}
          {#each notifications as notification}
            ...
            <div
              ...
              style:background={notification.is_read
                ? 'transparent'
            ...
            >
              <div class="flex gap-3">
                ...
                >
                  ...
                  <p class="text-xs mb-1 line-clamp-2" style:color="var(--color-text-secondary)">
      ...
      <!-- Footer -->
      {#if notifications.length > 0}
        <div class="px-4 py-3 text-center border-t" style:border-color="var(--color-border)">
          <a
            href="/notifications"
