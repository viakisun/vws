...
// 지출 항목별 필수 문서 체크
export function checkRequiredDocuments(expenseId: string, categoryCode: string): {
	complete: boolean;
	missing: string[];
	uploaded: string[];
} {
...
function getRequiredDocumentsForCategory(categoryCode: string): string[] {
	const docMap: Record<string, string[]> = {
		'PERSONNEL_CASH': ['participation_assignment', 'salary_statement', 'insurance_tax', 'salary_allocation'],
		'PERSONNEL_IN_KIND': ['participation_assignment', 'salary_statement', 'insurance_tax', 'salary_allocation'],
		'MATERIAL': ['requisition', 'quote', 'purchase_order', 'tax_invoice', 'delivery_note', 'inspection_report'],
