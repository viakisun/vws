...
export const projectActions = {
  ...
  async loadProjects(filters?: ProjectFilters) {
    ...
    try {
      ...
      const response = await fetch(`/api/research-development/projects?${params}`)
  ...
  async updateProject(id: string, projectData: Record<string, unknown>) {
    ...
    try {
      const response = await fetch(`/api/research-development/projects/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(projectData),
      })
...
export const projectMemberActions = {
  ...
  async loadProjectMembers(projectId: string) {
    try {
      const response = await fetch(`/api/research-development/projects/${projectId}/members`)
  ...
  async addProjectMember(memberData: Record<string, unknown>) {
    ...
    try {
      const response = await fetch('/api/research-development/project-members', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  async updateProjectMember(id: string, memberData: Record<string, unknown>) {
    ...
    try {
      const response = await fetch(`/api/research-development/project-members/${id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(memberData),
      })
...
export const participationRateActions = {
  ...
  async loadParticipationRates(filters?: ParticipationRateFilters) {
    try {
      ...
      const response = await fetch(`/api/research-development/participation-rates?${params}`)
  ...
  async loadEmployeeParticipationSummary() {
    try {
      const response = await fetch('/api/research-development/participation-rates/summary')
  ...
  async updateParticipationRate(rateData: Record<string, unknown>) {
    ...
    try {
      const response = await fetch('/api/research-development/participation-rates', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  async loadParticipationRateHistory(employeeId?: string, projectId?: string) {
    try {
      ...
      const response = await fetch(
        `/api/research-development/participation-rates/history?${params}`,
      )
...
export const budgetActions = {
  ...
  async loadProjectBudgets(projectId: string) {
    try {
      const response = await fetch(`/api/research-development/projects/${projectId}/budgets`)
  ...
  async loadBudgetSummaryByYear() {
    try {
      const response = await fetch('/api/research-development/budgets/summary-by-year')
  ...
  async saveProjectBudget(budgetData: Record<string, unknown>) {
    ...
    try {
      ...
      const url = isUpdate
        ? `/api/research-development/project-budgets/${budgetData.id}`
        : '/api/research-development/project-budgets'
...
export const alertActions = {
  ...
  async loadAlerts() {
    try {
      const response = await fetch('/api/research-development/alerts')
