...
export async function getProjects(): Promise<Project[]> {
  const data = await fetchApi<Project[]>('/api/research-development/projects')
  return data || []
}
...
export async function getProject(projectId: string): Promise<Project> {
  return fetchApi<Project>(`/api/research-development/projects/${projectId}`)
}
...
export async function createProject(projectData: Partial<Project>): Promise<Project> {
  return fetchApi<Project>('/api/research-development/projects', {
    method: 'POST',
...
export async function deleteProject(projectId: string): Promise<void> {
  await fetch(`/api/research-development/projects/${projectId}`, {
    method: 'DELETE',
  })
