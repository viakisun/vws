    ...
    <div class="bg-white rounded-lg max-w-md w-full p-6">
      ...
      >
        <div class="space-y-4">
          ...
          <!-- 역할 -->
          <div>
            <label for="recipient-role" class="block text-sm font-medium text-gray-700 mb-1"
              >역할</label
            >
            <select
              id="recipient-role"
          ...
          <!-- 알림 설정 -->
          <div>
            <div aria-label="알림 설정" class="block text-sm font-medium text-gray-700 mb-2">
              알림 설정
            </div>
            <div class="space-y-2">
              <div class="flex items-center">
                <input
                  ...
                  class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <label for="daily-report" class="ml-2 block text-sm text-gray-700"
                  >일일 리포트</label
                >
              </div>
              <div class="flex items-center">
                <input
                  ...
                  class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <label for="weekly-report" class="ml-2 block text-sm text-gray-700"
                  >주간 리포트</label
                >
              </div>
              <div class="flex items-center">
                <input
                  ...
                  class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
                <label for="monthly-report" class="ml-2 block text-sm text-gray-700"
                  >월간 리포트</label
                >
              </div>
              <div class="flex items-center">
