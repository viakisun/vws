...
const getDbConfig = () => {
  return {
    host:
      ...
      "db-viahub.cdgqkcss8mpj.ap-northeast-2.rds.amazonaws.com",
...
export class DatabaseService {
  ...
  static async createCompany(
    companyData: Partial<DatabaseCompany>,
  ...
  static async getExpenseItemById(
    id: string,
  ): Promise<DatabaseExpenseItem | null> {
    const result = await query<DatabaseExpenseItem>(
  ...
  static async createEmployee(
    employeeData: Partial<DatabaseEmployee>,
