...
export class DatabaseService {
	...
	// Expense operations
	static async createExpenseItem(expenseData: Partial<DatabaseExpenseItem>): Promise<DatabaseExpenseItem> {
	...
	static async createTransaction(transactionData: Partial<DatabaseTransaction>): Promise<DatabaseTransaction> {
