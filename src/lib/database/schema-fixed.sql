-- Workstream Database Schema (Updated)
-- PostgreSQL Database Schema for Integrated Business Management System
-- Updated: 2024-01-15 - All DATE columns converted to TIMESTAMP WITH TIME ZONE
...
-- Transactions (FIXED: date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE transactions (
    ...
    date TIMESTAMP WITH TIME ZONE NOT NULL, -- FIXED: Was DATE
...
-- Employees (FIXED: hire_date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE employees (
    ...
    hire_date TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    salary DECIMAL(12,2),
...
-- Leave Requests (FIXED: start_date, end_date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE leave_requests (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    employee_id UUID REFERENCES employees(id),
    leave_type_id UUID REFERENCES leave_types(id),
    start_date TIMESTAMP WITH TIME ZONE NOT NULL, -- FIXED: Was DATE
    end_date TIMESTAMP WITH TIME ZONE NOT NULL, -- FIXED: Was DATE
...
-- Projects (FIXED: start_date, end_date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE projects (
    ...
    start_date TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    end_date TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    manager_id UUID REFERENCES employees(id),
...
-- Reports (FIXED: period_start, period_end -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE reports (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    project_id UUID REFERENCES projects(id),
    type VARCHAR(50) NOT NULL, -- 'weekly', 'quarterly'
    period_start TIMESTAMP WITH TIME ZONE NOT NULL, -- FIXED: Was DATE
    period_end TIMESTAMP WITH TIME ZONE NOT NULL, -- FIXED: Was DATE
...
-- Leads (FIXED: last_contact -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE leads (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    source VARCHAR(100),
    notes TEXT,
    last_contact TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    created_by UUID REFERENCES users(id),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);

-- Sales Activities (FIXED: date, next_action_date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE sales_activities (
    ...
    next_action_date TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    created_by UUID REFERENCES users(id),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- Customer Interactions (FIXED: date, next_action_date -> TIMESTAMP WITH TIME ZONE)
...
-- Contracts (FIXED: start_date, end_date, renewal_date -> TIMESTAMP WITH TIME ZONE)
CREATE TABLE contracts (
    ...
    renewal_date TIMESTAMP WITH TIME ZONE, -- FIXED: Was DATE
    notes TEXT,
    created_by UUID REFERENCES users(id),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
