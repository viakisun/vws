...
<div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
  ...
  <Card>
    <div class="kpi">
      <div>
        <p class="text-caption">PASS</p>
        <div class="text-2xl font-bold">{passCnt}</div>
      </div>
    </div>
  </Card>
  <Card>
    <div class="kpi">
      <div>
        <p class="text-caption">WARN</p>
        <div class="text-2xl font-bold">{warnCnt}</div>
      </div>
    </div>
  </Card>
  <Card>
    <div class="kpi">
      <div>
        <p class="text-caption">FAIL</p>
        <div class="text-2xl font-bold">{failCnt}</div>
      </div>
    </div>
  </Card>
</div>
