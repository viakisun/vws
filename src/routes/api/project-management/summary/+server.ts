  ...
  try {
    ...
    const summary = {
      ...
      overParticipationEmployees:
        parseInt(overParticipation.over_participation_count) || 0,
      ...
      milestoneStats: {
        totalMilestones:
          parseInt(milestoneStatsResult.rows[0]?.total_milestones) || 0,
        completedMilestones:
          parseInt(milestoneStatsResult.rows[0]?.completed_milestones) || 0,
        overdueMilestones:
          parseInt(milestoneStatsResult.rows[0]?.overdue_milestones) || 0,
        upcomingMilestones:
          parseInt(milestoneStatsResult.rows[0]?.upcoming_milestones) || 0,
      },
