...
export async function POST() {
	try {
		console.log('🔄 참여율 컬럼을 DECIMAL로 변경하는 마이그레이션 시작...')
		...
		`)
		console.log('✅ project_members.participation_rate 변경 완료')
		...
		console.log('📋 변경된 컬럼들:', columns.rows)
		...
		console.error('❌ 참여율 컬럼 변경 실패:', error)
