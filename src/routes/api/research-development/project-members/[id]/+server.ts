...
async function getProjectById(
  ...
  return (await client.query(
    'SELECT start_date::text as start_date, end_date::text as end_date FROM rd_rd_projects WHERE id = $1',
    [projectId],
  )) as QueryResult<Record<string, unknown>>
}
...
/**
 * GET /api/research-development/project-members/[id] - 특정 프로젝트 멤버 조회
 */
...
/**
 * PUT /api/research-development/project-members/[id] - 프로젝트 멤버 수정
 */
...
/**
 * DELETE /api/research-development/project-members/[id] - 프로젝트 멤버 삭제
 */
