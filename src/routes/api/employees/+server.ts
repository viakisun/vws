  ...
  try {
    ...
    const employees = result.rows.map((row) => ({
      ...
      hire_date: row.hire_date
        ? formatDateForDisplay(row.hire_date, "ISO")
        : null,
      birth_date: row.birth_date
        ? formatDateForDisplay(row.birth_date, "ISO")
        : null,
  ...
  try {
    ...
    const formattedEmployee = {
      ...
      hire_date: employee.hire_date
        ? formatDateForDisplay(employee.hire_date, "ISO")
        : null,
      birth_date: employee.birth_date
        ? formatDateForDisplay(employee.birth_date, "ISO")
        : null,
