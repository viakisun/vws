				...
				<ThemeSpacer size={6}>
					...
					<ThemeCard class="p-6">
						...
						<ThemeGrid cols={1} mdCols={4} gap={4}>
							<div class="p-4 rounded-lg text-center" style="background: var(--color-surface-elevated);">
								...
								<div class="flex items-center justify-between p-4 rounded-lg border" style="border-color: var(--color-border); background: var(--color-surface-elevated);">
									<div class="flex items-center gap-3">
										...
										<div>
											...
											<p class="text-sm" style="color: var(--color-text-secondary);">{account.bank}</p>
										</div>
									</div>
							...
							{#each fundsReport.transactions as transaction}
								...
								<div class="flex items-center justify-between p-4 rounded-lg border" style="border-color: var(--color-border); background: var(--color-surface-elevated);">
									<div class="flex items-center gap-3">
										...
										<div>
											<h4 class="font-medium" style="color: var(--color-text);">{transaction.description}</h4>
									...
									<div class="text-right">
										<p class="text-lg font-bold" style="color: var(--color-{getTransactionTypeColor(transaction.type)});">
						...
						<div class="space-y-4">
							{#each fundsReport.transactions as transaction}
								...
								<div class="flex items-center justify-between p-4 rounded-lg border" style="border-color: var(--color-border); background: var(--color-surface-elevated);">
									...
									<div class="flex items-center gap-2">
										<span class="text-lg font-bold" style="color: var(--color-{getTransactionTypeColor(transaction.type)});">
											{transaction.type === 'inflow' ? '+' : '-'}{formatCurrency(transaction.amount)}
										</span>
										<ThemeButton variant="ghost" size="sm">
											<EditIcon size={16} />
