              ...
              <ThemeCard>
                <div class="flex items-center justify-center py-12">
                  <div class="text-center">
                    ...
                    <p
                      class="text-sm"
                      style:color="var(--color-text-secondary)">회사 정보를 불러오는 중...</p>
                  </div>
                </div>
              </ThemeCard>
            {:else if company}
              <ThemeCard>
                <div class="space-y-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h3
                        ...
                        style:color="var(--color-text)">기본 정보</h3>
                      <div class="space-y-3">
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">회사명</div>
                          <p
                            class="text-lg font-semibold"
                            style:color="var(--color-text)">{company.name}</p>
                        </div>
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">대표이사</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.ceo_name || '-'}</p>
                        </div>
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">설립일</div>
                          <p
                            class="text-base"
                        ...
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">업종</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.business_type || '-'}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <h3
                        class="text-lg font-semibold mb-4"
                        style:color="var(--color-text)">연락처 정보</h3>
                      <div class="space-y-3">
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">전화번호</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.phone || '-'}</p>
                        </div>
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">팩스번호</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.fax || '-'}</p>
                        </div>
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">이메일</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.email || '-'}</p>
                        </div>
                        <div>
                          <div
                            class="text-sm font-medium"
                            style:color="var(--color-text-secondary)">웹사이트</div>
                          <p
                            class="text-base"
                            style:color="var(--color-text)">{company.website || '-'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3
                      class="text-lg font-semibold mb-4"
                      style:color="var(--color-text)">주소 정보</h3>
                    <div>
                      <div
                        class="text-sm font-medium"
                        style:color="var(--color-text-secondary)">주소</div>
                      <p
                        class="text-base"
                        style:color="var(--color-text)">{company.address || '-'}</p>
                    </div>
                  </div>
                  ...
                  {#if company.registration_number}
                    <div>
                      <h3
                        class="text-lg font-semibold mb-4"
                        style:color="var(--color-text)">사업자 정보</h3>
                      <div>
                        <div
                          class="text-sm font-medium"
                          style:color="var(--color-text-secondary)">사업자등록번호</div>
                        <p
                          class="text-base"
                          style:color="var(--color-text)">{company.registration_number}</p>
                      </div>
                    </div>
                  {/if}
                </div>
              ...
              <ThemeCard>
                <div class="text-center py-12">
                  ...
                  <h3
                    ...
                    style:color="var(--color-text)">등록된 회사 정보가 없습니다</h3>
                  <p
                    class="text-sm mb-6"
                    style:color="var(--color-text-secondary)">
        ...
        <ThemeSpacer size={6}>
          <ThemeCard>
            <div class="text-center py-12">
              ...
              <h3
                class="text-lg font-semibold mb-2"
                style:color="var(--color-text)">프로필 설정</h3>
              <p
                class="text-sm"
                style:color="var(--color-text-secondary)">개인 프로필 설정 기능이 곧 추가될 예정입니다.</p>
            </div>
          </ThemeCard>
        </ThemeSpacer>
        ...
        <ThemeSpacer size={6}>
          <ThemeCard>
            <div class="text-center py-12">
              ...
              <p
                class="text-sm"
                style:color="var(--color-text-secondary)">보안 설정 기능이 곧 추가될 예정입니다.</p>
            </div>
          </ThemeCard>
        </ThemeSpacer>
        ...
        <ThemeSpacer size={6}>
          <ThemeCard>
            <div class="text-center py-12">
              ...
              <p
                class="text-sm"
                style:color="var(--color-text-secondary)">알림 설정 기능이 곧 추가될 예정입니다.</p>
            </div>
          </ThemeCard>
        </ThemeSpacer>
        ...
        <ThemeSpacer size={6}>
          <ThemeCard>
            <div class="text-center py-12">
              ...
              <p
                class="text-sm"
                style:color="var(--color-text-secondary)">외관 설정 기능이 곧 추가될 예정입니다.</p>
            </div>
          </ThemeCard>
        </ThemeSpacer>
      {:else if tab.id === 'data'}
        ...
        <ThemeSpacer size={6}>
          <ThemeCard>
            <div class="text-center py-12">
              ...
              <h3
                class="text-lg font-semibold mb-2"
                style:color="var(--color-text)">데이터 관리</h3>
              <p
                class="text-sm"
                style:color="var(--color-text-secondary)">데이터 관리 기능이 곧 추가될 예정입니다.</p>
            </div>
          </ThemeCard>
        </ThemeSpacer>
      {/if}
