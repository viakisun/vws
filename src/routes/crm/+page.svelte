...
>
	...
	>
							...
							<ThemeSpacer size={4}>
								{#each crmData.interactions as interaction}
									<div class="flex items-center justify-between p-3 rounded-lg" style="background: var(--color-surface-elevated);">
										<div class="flex-1">
											<h4 class="font-medium" style="color: var(--color-text);">{interaction.subject}</h4>
											<p class="text-sm" style="color: var(--color-text-secondary);">{interaction.customerName}</p>
								...
								{#each crmData.opportunities as opportunity}
									<div class="flex items-center justify-between p-3 rounded-lg" style="background: var(--color-surface-elevated);">
										<div class="flex-1">
											...
											<p class="text-sm" style="color: var(--color-text-secondary);">{opportunity.customerName}</p>
											<div class="flex items-center gap-2 mt-1">
		...
		{#each filteredCustomers() as customer}
				...
				{#if customer.notes}
											<p class="text-sm mt-2" style="color: var(--color-text-secondary);">{customer.notes}</p>
				{/if}
	</div>
									<div class="flex items-center gap-2">
