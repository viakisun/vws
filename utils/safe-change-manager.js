...
class SafeChangeManager {
    ...
    static async createChangePlan(filePath, changeType, description) {
        ...
        // 의존성 분석
        const analysis = await code_dependency_analyzer_1.CodeDependencyAnalyzer.analyzeProjectDependencies();
        ...
        const impacts = code_dependency_analyzer_1.CodeDependencyAnalyzer.predictChangeImpact(filePath, impactChangeType, analysis);
        // 안전한 변경 절차 생성
