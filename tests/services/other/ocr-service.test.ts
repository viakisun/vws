...
describe('OCRService', () => {
  ...
  describe('extractBankAccount', () => {
    ...
    it('should handle extraction errors', async () => {
      ...
      await expect(
        ocrService.extractBankAccount(mockFileBuffer, mockMimeType),
      ).rejects.toThrow('Bank account extraction failed')
    })
  ...
  describe('edge cases', () => {
    ...
    it('should handle unsupported MIME types', async () => {
      ...
      const result = await ocrService.extractBusinessRegistration(mockFileBuffer, unsupportedMimeType)
